            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  (formatter as any)(item.value, item.name, item, index, payload)
                ) : (
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentProps<"div"> & {
      ...
      formatter?: (value: string | undefined, entry: LegendPayload) => React.ReactNode
    }
>(
  (
    { className, hideIcon = false, payload = [], verticalAlign = "bottom", nameKey, layout = "horizontal", formatter },
    ref
  ) => {
    const { config } = useChart()
